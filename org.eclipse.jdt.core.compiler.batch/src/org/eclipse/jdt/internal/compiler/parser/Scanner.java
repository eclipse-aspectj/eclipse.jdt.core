 ...
 *     PARC             - initial implementation of AspectJ extension
 *     AspectJ team     - maintenance of AspectJ extension
 *******************************************************************************/
...
public TerminalToken scanIdentifierOrKeyword() {
	...
	return scanIdentifierOrKeywordAj(internalScanIdentifierOrKeyword(index, length, data));  // AspectJ extension: call AJ-specific decorator
}
public TerminalToken scanIdentifierOrKeywordAj(TerminalToken kind) {
	if (kind != TerminalToken.TokenNameIdentifier) return kind;
	...
	if (CharOperation.equals(aspectV, contents)) return TerminalToken.TokenNameaspect;
	else if (CharOperation.equals(pointcutV, contents)) return TerminalToken.TokenNamepointcut;
	else if (CharOperation.equals(privilegedV, contents)) return TerminalToken.TokenNameprivileged;
	else if (CharOperation.equals(beforeV, contents)) return TerminalToken.TokenNamebefore;
	else if (CharOperation.equals(afterV, contents)) return TerminalToken.TokenNameafter;
	else if (CharOperation.equals(aroundV, contents)) return TerminalToken.TokenNamearound;
	else if (CharOperation.equals(declareV, contents)) return TerminalToken.TokenNamedeclare;
